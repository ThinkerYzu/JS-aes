...
arraybufferMethod = function(){
  ...
  var encrypt_block = function(cipher_view8, cipher_view32, plain_view8, plain_view32, offset, scheduled_key){
    ...
    if( scheduled_key.byteLength >= 240 )
      round_end = 13;
    else if( scheduled_key.byteLength >= 204 )
      round_end = 11;
    else
      round_end = 9;
    var i;
